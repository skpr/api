...
type EnvironmentResourcesReplicas struct {
	...
	Current int32 `protobuf:"varint,1,opt,name=Current,proto3" json:"Current,omitempty"` // Number of replicas for a given environment.
...
func (x *EnvironmentResourcesReplicas) GetLimit() int64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type EnvironmentResourcesMemory struct {
	...
	Current int64 `protobuf:"varint,1,opt,name=Current,proto3" json:"Current,omitempty"` // Current number of replicas for a given environment.
	Min     int64 `protobuf:"varint,2,opt,name=Min,proto3" json:"Min,omitempty"`         // Minimum number of replicas for a given environment.
	Max     int64 `protobuf:"varint,3,opt,name=Max,proto3" json:"Max,omitempty"`         // Minimum number of replicas for a given environment.
}
...
func (x *EnvironmentResourcesMemory) GetMin() int64 {
	if x != nil {
		return x.Min
	}
	return 0
...
func (x *EnvironmentResourcesMemory) GetMax() int64 {
	if x != nil {
		return x.Max
	}
	return 0
...
var file_environment_proto_rawDesc = []byte{
	...
	0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x22, 0x4e,
	...
	0x07, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x4c, 0x69, 0x6d, 0x69,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x49,
	...
	0x28, 0x03, 0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x5a, 0x0a, 0x1a, 0x45, 0x6e, 0x76,
	...
	0x74, 0x12, 0x10, 0x0a, 0x03, 0x4d, 0x69, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03,
	0x4d, 0x69, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x4d, 0x61, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x03, 0x4d, 0x61, 0x78, 0x22, 0x67, 0x0a, 0x18, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e,
